...
### You'll need to download the BETA Teensy Software [here](https://www.arduino.cc/en/software). This is important because it enables file transfers from the micro SD without having to remove it from the Teensy. A mounted port can eliminate the need to open the phone at all (except to replace batteries_.
